...
namespace Class_Inheritance_And_Polymorphism
{
    public partial class ShiftSupervisorADD : Form
    {
        ...
        private void Btn_Add_ShiftSupervisor_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text != "" && int.TryParse(textBox2.Text, out value1)&& double.TryParse(textBox4.Text, out value2)&&
                    double.TryParse(textBox5.Text, out value3)&& comboBox1.SelectedIndex>-1)
            {
                ...
                else
                {
                    ...
                    Form1.CompanyEmployees.Add(Emp); // a shift supervisor is also an employee
